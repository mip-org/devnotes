...
An index of how the channel's custom mexopts XMLs — the files in
[mip_channel_tools/mexopts/](https://github.com/mip-org/mip_channel_tools/tree/main/mexopts)
— diverge from the MathWorks **stock** files, with the reasoning. The thorny
items each have their own deep-dive note (linked); this catalogs *everything*
and points there for detail.
